...
+---------------------------------------------------------------------------+
$Id: Statistics_migrateRawData_NoData.dal.test.php 30904 2009-01-14 16:29:40Z andrew.hill $
*/
...
class Test_OX_Dal_Maintenance_Statistics_migrateRawData_NoData extends UnitTestCase
{
     ...
     */
    function Test_OX_Dal_Maintenance_Statistics_migrateRawData_NoData()
    {
        $this->UnitTestCase();
